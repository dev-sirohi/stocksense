            ...
            {!results && !loading && (
                <div className="card bg-accent-light border-blue-200">
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed">
                        Each SKU description is converted into a 1536-number vector (embedding) by OpenAI. When you
                        search, your query is also embedded, and PostgreSQL's pgvector extension finds the SKUs whose
                        vectors point in the most similar direction — measuring the "angle" between them (cosine
                        similarity). Two items near each other in vector space share similar meaning, even if they share
                        no keywords.
                    </p>
                </div>
            )}
